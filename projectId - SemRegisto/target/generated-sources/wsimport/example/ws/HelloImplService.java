 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://ws.example/", wsdlLocation = "file:/home/joao/desktop/github/projectoSD/hello-ws_wsdl/src/main/resources/Hello.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://ws.example/", "HelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/home/joao/desktop/github/projectoSD/hello-ws_wsdl/src/main/resources/Hello.wsdl");
    ...
    public Hello getHelloImplPort() {
        return super.getPort(new QName("http://ws.example/", "HelloImplPort"), Hello.class);
    }
    ...
    public Hello getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.example/", "HelloImplPort"), Hello.class, features);
    }
